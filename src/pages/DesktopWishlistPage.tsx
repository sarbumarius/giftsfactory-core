            ...
            <div className="flex-1 overflow-y-auto pb-6">
              <div className="mx-4 rounded-2xl border border-border bg-white p-6">
                <div className="flex items-start justify-between gap-6">
                  <div>
                    <p className="text-xs font-semibold uppercase tracking-wide text-muted-foreground">Wishlist</p>
                    <h1 className="mt-2 text-3xl font-semibold text-foreground font-serif">Produsele salvate</h1>
                  </div>

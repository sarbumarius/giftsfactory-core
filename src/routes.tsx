...
const routes: RouteObject[] = [
  ...
  { path: "/en/cart", element: <CartPageEntry /> },
  { path: "/en/checkout", element: <CheckoutPageEntry /> },
  { path: "/en/wishlist", element: <WishlistPageEntry /> },
  { path: "/en/cont", element: <AccountPage /> },
  { path: "/en/discounts", element: <DiscountsPageEntry /> },
  { path: "/en/faq", element: <FAQPageEntry /> },
  { path: "/en/contact", element: <ContactPageEntry /> },
  { path: "/en/reviews", element: <ReviewsPageEntry /> },
  { path: "/en/about-me", element: <AboutPageEntry /> },
  { path: "/despre-noi", element: <AboutPageEntry /> },
